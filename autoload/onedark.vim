...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", { "gui": "#292D3E", "cterm": "238", "cterm16": "0" }),
      \ "visual_black": get(s:overrides, "visual_black", { "gui": "NONE", "cterm": "NONE", "cterm16": "0" }),
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#5C6370", "cterm": "259", "cterm16": "15" }),
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#78838e", "cterm": "238", "cterm16": "15" }),
      ...
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#181A1F", "cterm": "259", "cterm16": "15" }),
